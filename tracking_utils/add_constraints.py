...
from tracking_utils.library_constraints import ExactTrackCount, ExactSelectionsPerFrame
...
def add_constraints(
    ...
    Args:
        ...
        num_tracks: Exact number of tracks to find. Required when either
            set_exact_track_count or set_exact_selections_per_frame is True.
